  ...
  return (
    <div className="about">
      <h3 className="title">một chút thông tin về cibus...</h3>
        ...
        <p className="sub-title">Lorem Ipsum is simply dummy text of the printing
      ...
      <div className="bout-2">
          <div className="bout-2-grid">
            <img src="coca2.jpg" width="400px" className="bout-2-pic"/>
            <div className="bout-2-flex">
                <img src="beef.jpg" width="200px" height="150px"/>
      ...
      <div className="bout-footer">
          ...
          <div className="bout-footer-info">
              <p><span style={{fontWeight:'500'}}>Địa chỉ</span>: 123/4, tổ 5, phường 6, quận 7, TP Hồ Chí Minh</p>
              <p><span style={{fontWeight:'500'}}>Tel</span>: (012) 345 678 ~ 9</p>
              <p><span style={{fontWeight:'500'}}>Fax</span>: (012) 345 678 ~ 9</p>
              <p><span style={{fontWeight:'500'}}>Email</span>: cibus.contact@gmail.com</p>
          </div>
          <div className="bout-footer-form">
              <form>
                  <label for="title">Gửi thông tin hỗ trợ</label><br/>
                  <input className="form-control" type="text" id="email" name="email" placeholder="Nhập email của bạn"/> <br/>
